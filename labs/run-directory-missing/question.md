...
Fix the service definition so systemd creates the runtime directory automatically and the application starts normally. The app should also be reachable from the lab's exposed port in the browser.
